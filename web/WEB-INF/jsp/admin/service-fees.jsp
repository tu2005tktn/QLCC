                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination justify-content-center">
                            <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
                                <a class="page-link" href="${pageContext.request.contextPath}/admin/service-fees?page=${currentPage - 1}">Trước</a>
                            </li>
                            
                            <c:forEach begin="1" end="${totalPages}" var="i">
                                <li class="page-item ${currentPage == i ? 'active' : ''}">
                                    <a class="page-link" href="${pageContext.request.contextPath}/admin/service-fees?page=${i}">${i}</a>
                                </li>
                            </c:forEach>
                            
                            <li class="page-item ${currentPage == totalPages ? 'disabled' : ''}">
                                <a class="page-link" href="${pageContext.request.contextPath}/admin/service-fees?page=${currentPage + 1}">Sau</a>
                            </li>
                        </ul>
                    </nav>
                </c:if>
    ...
    <script>
        function filterTable() {
            ...
            for (let i = 1; i < rows.length; i++) {
                const apartment = rows[i].cells[1].textContent.toLowerCase();
                const monthYear = rows[i].cells[3].textContent; // Format: "MM/YYYY"
                const month = monthYear.split('/')[0];
                const year = monthYear.split('/')[1];
                const status = rows[i].cells[7].textContent.trim();
