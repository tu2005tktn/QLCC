    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        <form action="${pageContext.request.contextPath}/admin/apartments" method="get" class="d-flex">
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination justify-content-center">
                            <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
                                <a class="page-link" href="${pageContext.request.contextPath}/admin/apartments?page=${currentPage - 1}&keyword=${param.keyword}&floor=${param.floor}&status=${param.status}">Trước</a>
                            </li>
                            
                            <c:forEach begin="1" end="${totalPages}" var="i">
                                <li class="page-item ${currentPage == i ? 'active' : ''}">
                                    <a class="page-link" href="${pageContext.request.contextPath}/admin/apartments?page=${i}&keyword=${param.keyword}&floor=${param.floor}&status=${param.status}">${i}</a>
                                </li>
                            </c:forEach>
                            
                            <li class="page-item ${currentPage == totalPages ? 'disabled' : ''}">
                                <a class="page-link" href="${pageContext.request.contextPath}/admin/apartments?page=${currentPage + 1}&keyword=${param.keyword}&floor=${param.floor}&status=${param.status}">Sau</a>
                            </li>
                        </ul>
                    </nav>
                </c:if>
