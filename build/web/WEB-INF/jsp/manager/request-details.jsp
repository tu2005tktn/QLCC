            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <a href="${pageContext.request.contextPath}/manager/pending-requests" class="btn btn-sm btn-outline-secondary me-2">
                            ...
                            <div class="card-body">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <th>Căn hộ:</th>
                                        <td>
                                            <a href="${pageContext.request.contextPath}/apartments/view/${request.apartment.apartmentId}">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="${pageContext.request.contextPath}/manager/staff/${assignment.staff.userId}/view" class="text-decoration-none">
                                    ...
                                    <c:if test="${request.status eq 'Đang xử lý'}">
                                        <div class="d-grid gap-2 mt-3">
                                            <a href="${pageContext.request.contextPath}/requests/assign/${request.requestId}" class="btn btn-outline-primary">
                                                <i class="fas fa-user-edit me-1"></i> Phân công lại
                                            </a>
                                        </div>
                                    </c:if>
                                </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card mb-4">
                            <div class="card-header bg-warning text-dark">
                                <h5 class="mb-0"><i class="fas fa-edit me-2"></i>Cập nhật tiến độ</h5>
                            </div>
                            <div class="card-body">
